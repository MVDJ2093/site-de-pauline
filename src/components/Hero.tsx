    ...
    <section className="relative min-h-[50vh] flex items-center justify-center bg-navy text-white overflow-hidden">
      <div className="absolute left-0 top-0 md:top-44 w-full md:w-auto md:transform md:-translate-y-1/4">
        <img 
          ...
          className="w-full md:w-auto h-auto md:h-[633px] brightness-0 invert opacity-20 mt-24 md:mt-0"
        />
      </div>
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 font-aptos opacity-0 animate-[fadeIn_1.5s_ease-in-out_forwards] tracking-tight">
            ...
            <span className="text-2xl md:text-3xl block opacity-0 animate-[fadeIn_1.5s_ease-in-out_0.8s_forwards] tracking-wide mt-8 md:mt-4">
