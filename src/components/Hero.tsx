    ...
    <section className="relative min-h-[50vh] flex items-center justify-center bg-navy text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto mt-16">
          <h1 className="text-4xl md:text-6xl mb-6 font-aptos opacity-0 animate-[fadeIn_1.5s_ease-in-out_forwards] tracking-tight font-light ml-[30%]">
            ...
            <span className="text-2xl md:text-[2.6rem] block opacity-0 animate-[fadeIn_1.5s_ease-in-out_0.8s_forwards] tracking-wide mt-8 md:mt-4 font-extralight text-right">
              Fonction publique
            </span>
          </h1>
        </div>
