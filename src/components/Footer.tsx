...
const Footer = () => {
  return (
    <footer className="w-full flex justify-center px-4 py-6">
      <div className="w-[95%] bg-[#1A1F2C]/90 backdrop-blur-md rounded-2xl px-6 py-4 transition-all duration-500 hover:shadow-lg">
        <div className="flex justify-between items-start">
          <div className="flex items-start gap-12">
            ...
            <div className="flex flex-col space-y-2 text-[#f1f1f1] ml-auto">
